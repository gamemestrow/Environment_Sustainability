    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-[#0f0f0f] border border-green-600 rounded-xl p-6 shadow-lg">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          {/* Name */}
          <div>
            <label className="block text-sm text-green-400 mb-1">Full Name</label>
            <input
              type="text"
          ...
          {/* Email */}
          <div>
            <label className="block text-sm text-green-400 mb-1">Email Address</label>
            <input
              type="email"
          ...
          {/* Phone */}
          <div>
            <label className="block text-sm text-green-400 mb-1">Phone Number</label>
            <input
              type="tel"
